...
public class SessionManagerAdapter extends ArrayAdapter<Session> {
...
//	private SessionBusiness sessionBusiness;
	...
	public SessionManagerAdapter(SessionManagerActivity activity, int resource, int textViewResourceId, List<Session> value) {
...
// TODO Mise en commentaire a cause d'une exception OutOfMemory au 2eme chargement des images
//		    try {
