package com.runningstars.widget.textview;
...
public class TextFitView extends TextView {
	...
	public TextFitView(Context context, AttributeSet attrs) {
		super(context, attrs);
		parseAttrs(attrs);
		init();
	}

	public TextFitView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void onTextChanged(final CharSequence text, final int start, final int before, final int after) {
		mText = (text.length()>0) ? text.toString() : (getHint()!=null) ? getHint().toString() : "";
